...
const Speaker = () => {
  ...
  return (
    ...
    >
      {/* Content Container */}
      <div className="text-center mt-2 p-10 bg-black bg-opacity-80 rounded-lg shadow-lg w-4/5 md:w-3/5">
        {/* Title */}
        <h1 className="text-5xl font-extrabold mb-4 text-yellow-500">Expert Speakers</h1>
